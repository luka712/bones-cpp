...
#ifndef METAL_BASIC_MESH_TEST_MATERIAL_HPP
...
namespace bns
{
     ...
     */
    class MetalBasicMeshTestMaterial final : public Material
    {
    private:
    ...
    public:
        MetalBasicMeshTestMaterial(Framework &framework);
        ~MetalBasicMeshTestMaterial();

...
#ifndef BNS_UNLIT_SPRITE_RENDERER_OPENGL_HPP

#define BNS_UNLIT_SPRITE_RENDERER_OPENGL_HPP
...
namespace bns
{
    ...
    class OpenGLUnlitSpriteRenderer final : public SpriteRenderer
    {
    private:
        /// @brief The renderer.
        ...
        std::unordered_map<GLuint, std::stack<OpenGLUnlitSpritePipeline *>> m_allocatedPipelines;
        ...
        std::unordered_map<GLuint, std::stack<OpenGLUnlitSpritePipeline *>> m_currentDrawPipelines;
        ...
        OpenGLUnlitSpritePipeline &GetPipeline(OpenGLTexture2D *texture);

    public:
        OpenGLUnlitSpriteRenderer(Renderer *renderer);
